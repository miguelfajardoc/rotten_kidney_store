class Admin::SizesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @size.save
        ...
        format.json { render :show, status: :created, location: [ :admin, @size ] }
      else
  ...
  def update
    respond_to do |format|
      if @size.update(size_params)
        format.html { redirect_to [ :admin, @size ], notice: "Size was successfully updated.", status: :see_other }
        format.json { render :show, status: :ok, location: [ :admin, @size ] }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_sizes_path, notice: "Size was successfully destroyed.", status: :see_other }
