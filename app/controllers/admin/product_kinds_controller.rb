class Admin::ProductKindsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @product_kind.save
        format.html { redirect_to [ :admin, @product_kind ], notice: "Product kind was successfully created." }
        format.json { render :show, status: :created, location: [ :admin, @product_kind ] }
      else
  ...
  def update
    respond_to do |format|
      if @product_kind.update(product_kind_params)
        format.html { redirect_to [ :admin, @product_kind ], notice: "Product kind was successfully updated.", status: :see_other }
        format.json { render :show, status: :ok, location: [ :admin, @product_kind ] }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_product_kinds_path, notice: "Product kind was successfully destroyed.", status: :see_other }
